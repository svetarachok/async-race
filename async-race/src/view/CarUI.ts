...
export class CarUI {
  ...
  carSelectBtn: HTMLElement;

  carDeleteBtn: HTMLElement;
  ...
  constructor({ name, color, id }: CarInterface) {
    ...
    this.carSelectBtn = this.createElement('button', 'btn', `select-car-btn-${this.id}`);
    this.carDeleteBtn = this.createElement('button', 'btn', `delete-car-btn-${this.id}`);
    ...
    this.Startbtn = this.createElement('button', 'btn', 'start-race');
    this.Stopbtn = this.createElement('button', 'btn', 'stop-race');
  ...
  draw() {
    ...
    this.carWrapper.append(this.carControllers, this.carImgWrapper);
